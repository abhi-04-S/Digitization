...
weights = {
    "Artificial Intelligence (AI) & Machine Learning (ML)": 100,
    "Blockchain Technology": 100,
    "Cloud Computing & Infrastructure": 100,
    "Big Data & Analytics": 100,
    "Digital Technology Applications": 100,
    "Cybersecurity & Compliance": 100,
    "Digital Banking & Transformation": 100
}
...
if uploaded_files:
    ...
    if results:
        ...
        st.download_button("⬇ Download Results as CSV", data=csv, file_name="Digitization_Scores.csv", mime="text/csv")
